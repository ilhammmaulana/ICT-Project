                ...
                <div class="flex justify-between items-center gap-3 mt-5">
                    ...
                    <div class="flex gap-3 items-center">
                        <button class="btn" type="button"
                            onclick="add_new_course_module_modal.close()">Close</button>
    ...
    <script>
        ...
        const renderLinkPreview = () => {
            ...
            // Clear hidden inputs to avoid duplicates
            const linksHidden = document.getElementById("links");
            linksHidden.innerHTML = '';
