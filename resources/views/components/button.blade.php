...
switch ($variant) {
case 'primary':
$variantClasses = 'bg-theme-500 text-white hover:bg-theme-600 focus:ring-blue-500';
break;
case 'secondary':
$variantClasses = 'bg-white text-gray-500 hover:bg-gray-100 focus:ring-secondary-500 dark:text-gray-400
dark:bg-dark-eval-1
